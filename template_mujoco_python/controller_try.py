...
def init_controller(model,data):
    ...
    global f,u, u_val, xdot_des, xdot_val, desired_pos, current_pos, angular_velocity, x_val, des_vel,roll_angle, pitch_angle,r,p
    m = 1.0
    g = 9.81
    Ixx = Iyy = Izz = 1.0
...
#put the controller here. This function is called inside the simulation.
    global f,u, u_val, xdot_des, xdot_val, angular_velocity, x_val, des_vel, roll_angle, pitch_angle,r,p
    T_v = 20.0
    T_a = 15.0
    g = 9.81
    dt = .01 #sampling rate
